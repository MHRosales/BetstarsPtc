<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GanadoresUEFA.aspx.cs" Inherits="BetstarsPtc.GanadoresUEFA" %>
...
<body>
    ...
    <form runat="server">
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            ...
            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar"   />
        ...
        <main>
            ...
            <asp:TextBox ID="TxtContra" runat="server" placeholder="Pasword..." type="Pasword" class="form-control" onpaste="return false" minlength="2" MaxLength="15" />
             ...
             <br />
            <asp:Button ID="Button2" runat="server" BackColor="Red" BorderColor="Red" Text="Guardar" />
        </main>
