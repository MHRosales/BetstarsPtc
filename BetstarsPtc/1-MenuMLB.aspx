<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-MenuMLB.aspx.cs" Inherits="BetstarsPtc._1_MenuMLB" %>
...
<head runat="server">
    ...
    <title> BetStars | MLB's menu </title>
        <style type="text/css">
            .col-sn-12 {
                margin-left: 0px;
            }
...
<asp:ImageButton CssClass="btn-xl" ID="ImageButton1" ImageUrl="~/Imagenes/MetsDodgers.jpg" Width="600px" Height="300px" runat="server" OnClick="ImageButton1_Click"  />

                        <br />
                        <br />
                        <asp:ImageButton CssClass="btn-xl" ID="ImageButton2" ImageUrl="~/Imagenes/YankeesSox.jpg" Width="600px" Height="300px" runat="server" OnClick="ImageButton2_Click"  />
