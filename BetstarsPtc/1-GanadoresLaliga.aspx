<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-GanadoresLaliga.aspx.cs" Inherits="BetstarsPtc._1_GanadoresLaliga" %>
    ...
    <form runat="server">
        ...
        <main>
            ...
            <asp:TextBox ID="TxtContra" runat="server" placeholder="Pasword..." type="Pasword" class="form-control" onpaste="return false" minlength="2" MaxLength="15" />
             ...
             <br />
            <asp:Button ID="Button2" Height="60px" CssClass="btn-xl" BackColor="Red" BorderColor="Red" runat="server"  Text="Save" />
        </main>
