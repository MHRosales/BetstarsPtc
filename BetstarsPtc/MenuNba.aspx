<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuNba.aspx.cs" Inherits="BetstarsPtc.MenuNba" %>
...
<%--    <asp:Button ID="Button7" runat="server" Text="Regresar" BackColor="Red" BorderColor="Red" OnClick="Button7_Click" />--%>
    ...
    <h1>  Elija su Partido </h1>
                    ...
                    <div class="myform-top">
                      ...
                      <asp:ImageButton CssClass="btn-xl" ID="ImageButton1" ImageUrl="~/Images/CelticsWarriors.jpg" Width="600px" Height="375px" runat="server" OnClick="ImageButton7_Click"  />

                        <br />
                        <br />
                        <asp:ImageButton CssClass="btn-xl" ID="ImageButton2" ImageUrl="~/Images/MavericksHeats.jpg" Width="600px" Height="375px" runat="server" OnClick="ImageButton8_Click"  />
