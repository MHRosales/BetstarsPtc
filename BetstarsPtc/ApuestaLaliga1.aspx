<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApuestaLaliga1.aspx.cs" Inherits="BetstarsPtc.ApuestaLaliga1" %>
...
<%--            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar" OnClick="Regresar_Click" />--%>
        ...
        <main>
            ...
            <asp:TextBox ID="TxtUsuario" runat="server" placeholder="Usuario" type="Usuario" class="form-control" onpaste="return false" minlength="2" MaxLength="15" />
             ...
             <div class="form-group">
            <asp:TextBox ID="TxtContra" runat="server" placeholder="Pasword..." type="Password" class="form-control" onpaste="return false" minlength="2" MaxLength="15" />
            </div>
             <br />
