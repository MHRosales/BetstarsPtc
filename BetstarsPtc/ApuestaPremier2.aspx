<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApuestaPremier2.aspx.cs" Inherits="BetstarsPtc.ApuestaPremier2" %>
...
<%--            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar" OnClick="Regresar_Click" />--%>
                <a class="nav-link" href="MenuPremier.aspx" font-family="Avenir Next LT Pro"> Regresar</a>
