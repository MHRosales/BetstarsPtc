...
{
    public partial class CrudMisApuestas7 : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            if (ID != "")
            {
                ...
                var cmd0 = "SELECT Ganador from premier WHERE id_Apuesta='" + Id + "'";
                var cmd1 = "SELECT Puntos_equipo1 from premier WHERE id_Apuesta='" + Id + "'";
                var cmd2 = "SELECT Puntos_equipo2 from premier WHERE id_Apuesta='" + Id + "'";
                var cmd3 = "SELECT Apuesta from premier WHERE id_Apuesta='" + Id + "'";
                var cmd4 = "SELECT Usuario from premier WHERE id_Apuesta='" + Id + "'";
        ...
        protected void Unnamed2_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox7.Text != "" && TextBox6.Text != "")
            {
                ...
                if (retorno != 0)
                {
                    ...
                    var cmd1 = "SELECT id_Apuesta from ganadorpremier WHERE Ganador='" + Ganador + "'AND Puntos_equipo1='" + puntos1 + "' AND Puntos_equipo2='" + puntos2 + "';";
