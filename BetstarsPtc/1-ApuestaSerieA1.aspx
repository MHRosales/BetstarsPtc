<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-ApuestaSerieA1.aspx.cs" Inherits="BetstarsPtc._1_ApuestaSerieA1" %>
...
<%--            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar" OnClick="Regresar_Click" />--%>
                <a class="nav-link" href="1-MenuSerieA.aspx" font-family="Avenir Next LT Pro"> Back</a>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 myform-cont">
                        ...
                        <div>
                            <h3>
                                ...
                                <asp:ListItem>Inter di Milano</asp:ListItem>
