<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-MenuMundial.aspx.cs" Inherits="BetstarsPtc._1_MenuMundial" %>
...
<head runat="server">
    ...
    <title> BetStars | FIFA's menu </title>
        <style type="text/css">
            .col-sn-12 {
                margin-left: 0px;
            }
    ...
    <h1>  Choose your Game</h1>
                    ...
                    <div class="myform-top">
                        ...
                        <%--<asp:Button ID="Button2" runat="server" Text="Mundial" BackColor="Red" BorderColor="Red" Height="300px" Width="300px" OnClick="Button2_Click"/--%>
                                               <asp:ImageButton CssClass="btn-xl" ID="ImageButton1" ImageUrl="~/Images/QatEcuador.jpg" Width="600px" Height="200px" runat="server" OnClick="ImageButton1_Click"   />

                        <br />
                        <br />
<%--                        <asp:Button ID="Button3" runat="server" Text="NBA" BackColor="Red" BorderColor="Red" Height="300px" Width="300px"/>--%>
                                                                       <asp:ImageButton CssClass="btn-xl" ID="ImageButton2" ImageUrl="~/Images/ArgMex.jpg" Width="600px" Height="200px" runat="server" OnClick="ImageButton2_Click"  />
