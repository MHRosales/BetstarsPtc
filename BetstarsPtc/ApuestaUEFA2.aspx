<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApuestaUEFA2.aspx.cs" Inherits="BetstarsPtc.ApuestaUEFA2" %>
...
<%--            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar" OnClick="Regresar_Click" />--%>
                <a class="nav-link" href="MenuUEFA.aspx" font-family="Avenir Next LT Pro"> Regresar</a>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 myform-cont">
                        ...
                        <div>
                            <h3>
                                ...
                                <asp:ListItem>Paris Saint-Germain FC</asp:ListItem>
