<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-ApuestaUEFA2.aspx.cs" Inherits="BetstarsPtc._1_ApuestaUEFA2" %>
...
<%--            <asp:Button ID="Regresar" BackColor="Red" BorderColor="Red" runat="server" Text="Regresar" OnClick="Regresar_Click" />--%>
                <a class="nav-link" href="1-MenuUEFA.aspx" font-family="Avenir Next LT Pro"> Back</a>
