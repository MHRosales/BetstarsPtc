...
{
    public partial class CrudMisApuestas : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            if ( ID != "")
            {
                ...
                var cmd0 = "SELECT Ganador from mundial WHERE id_Apuesta='" + Id + "'";
                var cmd1 = "SELECT Puntos_equipo1 from mundial WHERE id_Apuesta='" + Id + "'";
                var cmd2 = "SELECT Puntos_equipo2 from mundial WHERE id_Apuesta='" + Id + "'";
                var cmd3 = "SELECT Apuesta from mundial WHERE id_Apuesta='" + Id + "'";
                var cmd4 = "SELECT Usuario from mundial WHERE id_Apuesta='" + Id + "'";
