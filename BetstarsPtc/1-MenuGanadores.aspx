<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-MenuGanadores.aspx.cs" Inherits="BetstarsPtc._1_MenuGanadores" %>
...
<head runat="server">
    ...
    <title> BetStars | Administrator's Menu </title>
        <style type="text/css">
            .col-sn-12 {
                margin-left: 0px;
            }
...
<%--    <asp:Button ID="Button10" runat="server" Text="Salir" CssClass="nav-item" OnClick="Button10_Click" />--%>
    <a class="nav-link" href="Idioma.aspx" font-family="Avenir Next LT Pro"> Log out</a>
      <a class="nav-link" href="1-Admin.aspx" font-family="Avenir Next LT Pro"> Back</a>
